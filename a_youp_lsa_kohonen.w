m4_define(m4_projname, `youp_lsa_kohonen')m4_dnl
m4_define(m4_amcathost, `http://amcat-dev.labs.vu.nl')m4_dnl
m4_dnl m4_define(m4_articlesetname, `minicorp')m4_dnl
m4_dnl m4_define(m4_articlesetid, `8402')m4_dnl
m4_define(m4_articlesetid, `45')m4_dnl
m4_define(m4_articlesetname, `youp')m4_dnl
m4_define(m4_docfreq_thres, `2')m4_dnl
m4_define(m4_docfreq_pct_max, `95')m4_dnl
m4_define(m4_word_grid_width, `21')m4_dnl
m4_define(m4_word_grid_height, `15')m4_dnl
m4_define(m4_word_grid_shape, `rectangular')m4_dnl
m4_define(m4_doc_grid_width, `8')m4_dnl
m4_define(m4_doc_grid_height, `8')m4_dnl
...
To help explore the word-clusters, add the Best Matching Unit (\BMU{})
associations to the vocabulary.

@d create a word-SOM @{@%
voca\$bmu<-term.som\$unit.classif
@|  @}
...
Figure~\ref{fig:wordsom} shows a trainings-parameter of the
word-\SOM{} and the population of the codevectors of the word-\SOM{}. %
\begin{figure}[hbtp]
  \centering
  \mbox{\includegraphics[width=5cm]{wordsom_changes.pdf} \hspace{1cm} \includegraphics[width=5cm]{wordsom_population.pdf}}
  \caption{The Word-\SOM{}. Left: mean distance  of the word-types to
    the codevectors during training; Right: poulation of the
    codevectors. }
  \label{fig:wordsom}
\end{figure}%
